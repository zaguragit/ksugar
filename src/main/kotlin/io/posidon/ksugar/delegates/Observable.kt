...
inline fun <T : Any?> Delegates.observable(crossinline onChange: (property: KProperty<*>, oldValue: T?, newValue: T?) -> Unit): ReadWriteProperty<Any?, T?> =
...
inline fun <T : Any?> Delegates.observable(crossinline onChange: (oldValue: T?, newValue: T?) -> Unit): ReadWriteProperty<Any?, T?> =
...
inline fun <T : Any?> Delegates.observable(crossinline onChange: (value: T?) -> Unit): ReadWriteProperty<Any?, T?> =
