...
inline fun <T> Delegates.vetoable(crossinline onChange: (property: KProperty<*>, oldValue: T?, newValue: T?) -> Boolean): ReadWriteProperty<Any?, T?> =
...
inline fun <T> Delegates.vetoable(crossinline onChange: (oldValue: T?, newValue: T?) -> Boolean): ReadWriteProperty<Any?, T?> =
...
inline fun <T> Delegates.vetoable(crossinline onChange: (value: T?) -> Boolean): ReadWriteProperty<Any?, T?> =
...
inline fun <T> Delegates.vetoable(crossinline onChange: () -> Boolean): ReadWriteProperty<Any?, T?> =
